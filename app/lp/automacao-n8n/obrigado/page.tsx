    ...
    useEffect(() => {
        ...
        if (typeof window !== 'undefined' && (window as any).gtag) {
            (window as any).gtag('event', 'conversion', {
                'send_to': 'AW-17848976773/X8hgCN2uq98bEIWLh79C', // Label de conversão específico da Automação
                'value': 1.0,
                'currency': 'BRL'
            });
        }

        // Meta Pixel Conversion Tracking (Generic Lead)
        ...
        <div className="flex flex-col w-full min-h-screen bg-white selection:bg-[#CEFF05] selection:text-slate-950 font-sans">
            ...
            <main className="flex-1 flex items-center justify-center pt-20 pb-12 px-4">
                <div className="max-w-2xl w-full text-center">
                    ...
                    >
                        Obrigado por seu interesse! Nossa equipe de automação <br className="hidden md:block" />
                    ...
                    >
                        ...
                        <div className="space-y-4 text-left max-w-md mx-auto">
                            {[
                                ...
                                { step: 3, text: "Agendaremos um mapeamento de processos" },
                                { step: 4, text: "Apresentaremos uma proposta de automação" },
                            ].map((item, i) => (
